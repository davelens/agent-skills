---
url: https://docs.voidlinux.org/config/network/networkmanager.html
title: NetworkManager - The Void Linux Handbook
words: 202
---
NetworkManager
...
Before enabling the NetworkManager daemon, disable any other network management services, such as dhcpcd, wpa\supplicant, or wicd. These services all control network interface configuration, and will interfere with NetworkManager.
...
Download the correct eduroam\_cat installer for your institution from here and execute it. It will provide a user interface guiding you through the process.

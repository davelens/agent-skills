---
url: https://docs.voidlinux.org/config/graphical-session/kde.html
title: KDE - The Void Linux Handbook
words: 277
---
KDE
...
The kde-plasma package does not include the default KDE Plasma system sounds. If you wish to install the default system sounds theme, install the ocean-sound-theme package. Legacy sounds can be installed with the oxygen-sounds package.

Browser Integration

If you wish to enable browser integration, install the plasma-browser-integration package.

...
title: Typography · Bootstrap v5.3
words: 1747
---
View on GitHub
...
These styles can be found within reboot.scss, and the global variables are defined in variables.scss. Make sure to set $font-size-base in rem.

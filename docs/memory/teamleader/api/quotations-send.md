---
url: https://developer.focus.teamleader.eu/docs/api/quotations-send
title: quotations.send | Teamleader Developers
words: 575
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/quotations.send
```
...
- quotationsstring\[]required
  ...
  languageQuotationLanguagerequired

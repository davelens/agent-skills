---
url: https://developer.focus.teamleader.eu/docs/api/nextgen-projects-materials-assign
title: materials.assign | Teamleader Developers
words: 221
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/projects-v2/materials.assign
```

---
url: https://developer.focus.teamleader.eu/docs/api/nextgen-projects-materials-info
title: materials.info | Teamleader Developers
words: 989
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/projects-v2/materials.info
```

---
url: https://developer.focus.teamleader.eu/docs/api/deal-phases-duplicate
title: dealPhases.duplicate | Teamleader Developers
words: 240
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/dealPhases.duplicate
```

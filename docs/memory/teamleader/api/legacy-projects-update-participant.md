---
url: https://developer.focus.teamleader.eu/docs/api/legacy-projects-update-participant
title: projects.updateParticipant | Teamleader Developers
words: 226
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/projects.updateParticipant
```

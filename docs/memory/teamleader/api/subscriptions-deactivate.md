---
url: https://developer.focus.teamleader.eu/docs/api/subscriptions-deactivate
title: subscriptions.deactivate | Teamleader Developers
words: 182
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/subscriptions.deactivate
```

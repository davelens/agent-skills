---
url: https://developer.focus.teamleader.eu/docs/api/meetings-complete
title: meetings.complete | Teamleader Developers
words: 183
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/meetings.complete
```

---
url: https://developer.focus.teamleader.eu/docs/api/webhooks-unregister
title: webhooks.unregister | Teamleader Developers
words: 298
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/webhooks.unregister
```
...
var request = new HttpRequestMessage(HttpMethod.Post, "https://api.focus.teamleader.eu/webhooks.unregister");

---
url: https://developer.focus.teamleader.eu/docs/api/incoming-invoices-send-to-bookkeeping
title: incomingInvoices.sendToBookkeeping | Teamleader Developers
words: 184
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/incomingInvoices.sendToBookkeeping
```

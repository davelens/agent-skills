---
url: https://developer.focus.teamleader.eu/docs/api/user-availability-total
title: userAvailability.total | Teamleader Developers
words: 428
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/userAvailability.total
```

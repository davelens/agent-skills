---
url: https://developer.focus.teamleader.eu/docs/api/incoming-credit-notes-info
title: incomingCreditNotes.info | Teamleader Developers
words: 428
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/incomingCreditNotes.info
```

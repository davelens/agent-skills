---
url: https://developer.focus.teamleader.eu/docs/api/project-groups-assign
title: projectGroups.assign | Teamleader Developers
words: 221
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/projects-v2/projectGroups.assign
```
...
var request = new HttpRequestMessage(HttpMethod.Post, "https://api.focus.teamleader.eu/projects-v2/projectGroups.assign");

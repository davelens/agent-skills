---
url: https://developer.focus.teamleader.eu/docs/api/nextgen-projects-add-owner
title: projects.addOwner | Teamleader Developers
words: 201
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/projects-v2/projects.addOwner
```

---
url: https://developer.focus.teamleader.eu/docs/api/incoming-invoices-update-payment
title: incomingInvoices.updatePayment | Teamleader Developers
words: 273
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/incomingInvoices.updatePayment
```

Update a payment for an incoming invoice.
...
var request = new HttpRequestMessage(HttpMethod.Post, "https://api.focus.teamleader.eu/incomingInvoices.updatePayment");

...
- **docs-* skill family**: offline third-party docs mirrors and their metadata live under [`docs/tooling/`](../tooling/index.md), outside project memory. Versioned mirrors: Bootstrap, Quill, Quickshell. Unversioned mirrors: Teamleader, Void.

---
url: https://developer.focus.teamleader.eu/docs/api/tickets-import-message
title: tickets.importMessage | Teamleader Developers
words: 311
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/tickets.importMessage
```

---
url: https://developer.focus.teamleader.eu/docs/api/incoming-invoices-add
title: incomingInvoices.add | Teamleader Developers
words: 383
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/incomingInvoices.add
```

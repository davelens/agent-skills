---
url: https://developer.focus.teamleader.eu/docs/api/invoices-copy
title: invoices.copy | Teamleader Developers
words: 232
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/invoices.copy
```

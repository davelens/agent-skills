---
url: https://developer.focus.teamleader.eu/docs/api/receipts-update
title: receipts.update | Teamleader Developers
words: 297
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/receipts.update
```

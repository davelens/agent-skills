---
url: https://developer.focus.teamleader.eu/docs/api/legacy-milestones-create
title: milestones.create | Teamleader Developers
words: 406
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/milestones.create
```
...
- oneOf
  ...
  Possible values: \[noninvoiceable, timeand_materials]
  
  Default value: timeandmaterials

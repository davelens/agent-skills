---
url: https://developer.focus.teamleader.eu/docs/api/nextgen-projects-materials-update
title: materials.update | Teamleader Developers
words: 623
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/projects-v2/materials.update
```

---
url: https://developer.focus.teamleader.eu/docs/api/receipts-list-payments
title: receipts.listPayments | Teamleader Developers
words: 321
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/receipts.listPayments
```

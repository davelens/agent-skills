---
url: https://developer.focus.teamleader.eu/docs/api/quotations-download
title: quotations.download | Teamleader Developers
words: 261
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/quotations.download
```

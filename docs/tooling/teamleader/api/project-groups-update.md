---
url: https://developer.focus.teamleader.eu/docs/api/project-groups-update
title: projectGroups.update | Teamleader Developers
words: 551
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/projects-v2/projectGroups.update
```
...
- idstringrequired
  ...
  update\_strategystringrequired
  ...
  Only allowed if the billing\method is fixed\price, or the group is already fixed\_price.
  ...
  Also known as "budget". Value set by user to compare with price. Only allowed if the billing\method is time\and\materials, or the group is already time\and\_materials.

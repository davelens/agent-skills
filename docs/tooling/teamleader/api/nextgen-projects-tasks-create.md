---
url: https://developer.focus.teamleader.eu/docs/api/nextgen-projects-tasks-create
...
```
POST https://api.focus.teamleader.eu/projects-v2/tasks.create
```
...
- project\_idstringrequired
  ...
  Cannot be null if billingmethod is tasktype_rate.

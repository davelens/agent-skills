---
url: https://developer.focus.teamleader.eu/docs/api/cloud-platforms-url
title: cloudPlatforms.url | Teamleader Developers
words: 239
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/cloudPlatforms.url
```

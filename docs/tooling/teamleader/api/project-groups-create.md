---
url: https://developer.focus.teamleader.eu/docs/api/project-groups-create
title: projectGroups.create | Teamleader Developers
words: 567
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/projects-v2/projectGroups.create
```

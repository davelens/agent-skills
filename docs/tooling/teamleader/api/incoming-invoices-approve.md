---
url: https://developer.focus.teamleader.eu/docs/api/incoming-invoices-approve
title: incomingInvoices.approve | Teamleader Developers
words: 182
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/incomingInvoices.approve
```

---
url: https://developer.focus.teamleader.eu/docs/api/deal-pipelines-delete
title: dealPipelines.delete | Teamleader Developers
words: 230
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/dealPipelines.delete
```

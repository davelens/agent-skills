---
url: https://developer.focus.teamleader.eu/docs/api/quotations-update
title: quotations.update | Teamleader Developers
words: 706
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/quotations.update
```
...
var request = new HttpRequestMessage(HttpMethod.Post, "https://api.focus.teamleader.eu/quotations.update");

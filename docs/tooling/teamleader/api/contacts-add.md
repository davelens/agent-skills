---
url: https://developer.focus.teamleader.eu/docs/api/contacts-add
title: contacts.add | Teamleader Developers
words: 618
---
- [](/)
- API Reference
...
var request = new HttpRequestMessage(HttpMethod.Post, "https://api.focus.teamleader.eu/contacts.add");

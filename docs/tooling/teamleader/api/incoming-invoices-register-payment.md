---
url: https://developer.focus.teamleader.eu/docs/api/incoming-invoices-register-payment
title: incomingInvoices.registerPayment | Teamleader Developers
words: 300
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/incomingInvoices.registerPayment
```
...
var request = new HttpRequestMessage(HttpMethod.Post, "https://api.focus.teamleader.eu/incomingInvoices.registerPayment");

---
url: https://developer.focus.teamleader.eu/docs/api/tickets-add-internal-message
title: tickets.addInternalMessage | Teamleader Developers
words: 278
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/tickets.addInternalMessage
```
...
var request = new HttpRequestMessage(HttpMethod.Post, "https://api.focus.teamleader.eu/tickets.addInternalMessage");

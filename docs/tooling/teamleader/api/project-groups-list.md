---
url: https://developer.focus.teamleader.eu/docs/api/project-groups-list
title: projectGroups.list | Teamleader Developers
words: 955
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/projects-v2/projectGroups.list
```

---
url: https://developer.focus.teamleader.eu/docs/api/deal-phases-move
title: dealPhases.move | Teamleader Developers
words: 198
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/dealPhases.move
```

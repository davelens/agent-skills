---
url: https://developer.focus.teamleader.eu/docs/api/calls-add
title: calls.add | Teamleader Developers
words: 387
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/calls.add
```

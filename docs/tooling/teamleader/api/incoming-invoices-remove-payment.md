---
url: https://developer.focus.teamleader.eu/docs/api/incoming-invoices-remove-payment
title: incomingInvoices.removePayment | Teamleader Developers
words: 197
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/incomingInvoices.removePayment
```

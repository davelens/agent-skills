---
url: https://developer.focus.teamleader.eu/docs/api/incoming-invoices-update
title: incomingInvoices.update | Teamleader Developers
words: 338
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/incomingInvoices.update
```
...
var request = new HttpRequestMessage(HttpMethod.Post, "https://api.focus.teamleader.eu/incomingInvoices.update");

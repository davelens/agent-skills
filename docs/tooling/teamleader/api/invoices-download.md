---
url: https://developer.focus.teamleader.eu/docs/api/invoices-download
title: invoices.download | Teamleader Developers
words: 263
---
- [](/)
- API Reference
...
- idstringrequired
  ...
  Possible values: \[pdf, ubl/e-fff, ubl/peppolbis3]
...
var request = new HttpRequestMessage(HttpMethod.Post, "https://api.focus.teamleader.eu/invoices.download");

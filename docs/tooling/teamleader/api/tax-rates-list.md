---
url: https://developer.focus.teamleader.eu/docs/api/tax-rates-list
title: taxRates.list | Teamleader Developers
words: 358
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/taxRates.list
```

---
url: https://developer.focus.teamleader.eu/docs/api/project-lines-list
title: projectLines.list | Teamleader Developers
words: 378
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/projects-v2/projectLines.list
```

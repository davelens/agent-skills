---
url: https://developer.focus.teamleader.eu/docs/api/deal-phases-delete
title: dealPhases.delete | Teamleader Developers
words: 197
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/dealPhases.delete
```

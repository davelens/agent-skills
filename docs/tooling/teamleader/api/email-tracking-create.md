---
url: https://developer.focus.teamleader.eu/docs/api/email-tracking-create
title: emailTracking.create | Teamleader Developers
words: 330
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/emailTracking.create
```

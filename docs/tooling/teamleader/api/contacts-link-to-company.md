---
url: https://developer.focus.teamleader.eu/docs/api/contacts-link-to-company
title: contacts.linkToCompany | Teamleader Developers
words: 211
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/contacts.linkToCompany
```

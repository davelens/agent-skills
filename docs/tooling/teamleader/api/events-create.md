---
url: https://developer.focus.teamleader.eu/docs/api/events-create
title: events.create | Teamleader Developers
words: 360
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/events.create
```

---
url: https://developer.focus.teamleader.eu/docs/api/quotations-accept
title: quotations.accept | Teamleader Developers
words: 183
---
- [](/)
- API Reference
...
```
POST https://api.focus.teamleader.eu/quotations.accept
```

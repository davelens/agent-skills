---
url: https://docs.voidlinux.org/xbps/repositories/restricted.html
title: Restricted Packages - The Void Linux Handbook
words: 174
---
Restricted Packages
...
Remember that the building of restricted packages must be enabled explicitly by setting XBPSALLOWRESTRICTED=yes in your xbps-src configuration (in the etc/conf file in the repository.)

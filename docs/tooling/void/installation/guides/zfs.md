---
url: https://docs.voidlinux.org/installation/guides/zfs.html
title: Root on ZFS - The Void Linux Handbook
words: 1049
---
...
As needed, format the EFI system partition using mkfs.vfat(8) and the boot partition using mke2fs(8) or mkfs.xfs(8). Initialize any swap space using mkswap(8).

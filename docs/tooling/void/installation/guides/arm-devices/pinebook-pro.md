---
url: https://docs.voidlinux.org/installation/guides/arm-devices/pinebook-pro.html
title: Pinebook Pro - The Void Linux Handbook
words: 137
---
Pinebook Pro
...
See Pine64's documentation for more information.

Installation

The live ISO provided by Void is generic and does not have U-Boot integrated. You need to provide your own firmware installed on the internal SPI flash, eMMC, or an SD card, such as Tow-Boot or rk2aw.
...
> Note: if using another bootloader, ensure the kernel cmdline arguments console=ttyS2,115200 video=eDP-1:1920x1080x60 are used.

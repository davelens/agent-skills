---
url: https://docs.voidlinux.org/config/ssd.html
title: Solid State Drives - The Void Linux Handbook
words: 486
---
Solid State Drives
...
If your root device is on LUKS, add rd.luks.allow-discards to CMDLINELINUXDEFAULT. In the case of GRUB, edit /etc/default/grub:

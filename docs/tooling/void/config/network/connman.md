---
url: https://docs.voidlinux.org/config/network/connman.html
title: ConnMan - The Void Linux Handbook
words: 175
---
ConnMan
...
To enable the ConnMan daemon, first disable any other network managing services like dhcpcd, wpa\supplicant, or wicd. These services all control network interface configuration, and interfere with each other.

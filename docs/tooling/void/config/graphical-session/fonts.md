---
url: https://docs.voidlinux.org/config/graphical-session/fonts.html
title: Fonts - The Void Linux Handbook
words: 151
---
Fonts
...
Fontconfig disables usage bitmap fonts by default. To enable them, enable the configuration file 70-yes-bitmaps.conf:

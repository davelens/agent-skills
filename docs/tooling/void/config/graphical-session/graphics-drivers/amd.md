---
url: https://docs.voidlinux.org/config/graphical-session/graphics-drivers/amd.html
title: AMD or ATI - The Void Linux Handbook
words: 180
---
AMD or ATI
...
For VA-API, install the mesa-vaapi package. To ensure the AMD VA-API driver is used, set the environment variable LIBVADRIVERNAME to radeonsi.

---
url: https://docs.voidlinux.org/config/services/user-services.html
title: Per-User Services - The Void Linux Handbook
words: 476
---
Per-User Services
...
To give user services access to important environment variables, chpst(8)'s envdir functionality can be used. Inside user services, the convenience variable TURNSTILEENVDIR can be used to refer to this directory.

To make a service aware of these variables, wrap the exec line with chpst -e "$TURNSTILEENVDIR":

---
url: https://quilljs.com/docs/modules/clipboard/
title: Clipboard Module - Quill Rich Text Editor
words: 352
---
Clipboard Module
...
Adds a custom matcher to the Clipboard. Matchers using nodeType are called first, in the order they were added, followed by matchers using a CSS selector, also in the order they were added. nodeType may be Node.ELEMENTNODE or Node.TEXTNODE.
...
[](#dangerouslypastehtml)dangerouslyPasteHTML

...
- Never call `AskClaude` unless the user explicitly asks to use Claude or AskClaude in their current message. Never use it automatically for reviews, validation, fallback, planning, or task completion
